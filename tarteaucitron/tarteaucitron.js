...
function	get_tarteaucitron_params () {
	return ({
		"adblocker": false,
		"hashtag": '#tarteaucitron',
		"cookieName": 'cookie_markus',
		"highPrivacy": true,
		"orientation": "bottom",
		"bodyPosition": "bottom",
		"removeCredit": true,
		...
		"AcceptAllCta" : true,
		"moreInfoLink": false,
		"privacyUrl": "https://www.eiffage-immobilier.fr/politique-confidentialite",
...
var		tarteaucitron_params = get_tarteaucitron_params();
...
var tarteaucitron = {
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.parameters.privacyUrl !== "") {
					...
					html += '		<a href="' + tarteaucitron.parameters.privacyUrl + '" target="_blank">';
					html += '       	' + tarteaucitron.lang.privacyUrl;
					html += '		</a>'
                    html += '   </button>';
                }
                html += '         </div>';
                html += '         <div id="cta_all"><div class="tarteaucitronName">';
                ...
                html += '         </div></div>';
                html += '      </div>';
                html += '      <div id="tarteaucitron_services" class="tarteaucitronBorder">';
                ...
                if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.AcceptAllCta) {
					...
					html += '<div id="tarteaucitronAlertBig" class="tarteaucitronAlertBig' + orientation + '"><div id="big_wrapper">';
                    //html += '<div class="tarteaucitronAlertBigWrapper">';
                    ...
                    html += '   </div>';
                    //html += '   <span class="tarteaucitronAlertBigBtnWrapper">';
                    html += '   <div id="button_grp"> <button type="button" class="tarteaucitronCTAButton tarteaucitronAllow" id="tarteaucitronPersonalize2">';
                    ...
                    html += '       ' + tarteaucitron.lang.personalize;
					html += '   </button> </div>';
					html += '	</div><div id="tarteaucitron_quit"></div>';
                ...
                setTimeout(function () {
					...
					// tarteaucitron.addClickEventToId("tarteaucitron_quit", function () {
					// 	document.getElementById('tarteaucitronAlertBig').style.display = 'none';
					// 	document.getElementById('tarteaucitronIcon').style.display = 'block';
					// });
					tarteaucitron.addClickEventToId("tarteaucitron_quit", function () {
            ...
            for (index = 0; index < tarteaucitron.job.length; index += 1) {
                ...
                if (tarteaucitron.state[key] !== status) {
                    ...
                    if (tarteaucitron.launch[key] !== true && status === true) {
						...
						tarteaucitron.reloadThePage = true; // Ligne ajoutée : on recharge la page
                    }
    ...
    "getLocale": function () {
        ...
        var lang = navigator.language || navigator.browserLanguage ||
                navigator.systemLanguage || navigator.userLang || null,
            userLanguage = lang ? lang.substr(0, 2) : 'fr';
...
tarteaucitron.init(tarteaucitron_params);
